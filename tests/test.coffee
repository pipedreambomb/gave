...
describe 'Giving Counts', ->
  ...
  beforeEach (done) -> loginAsTestUser.call this, done
  ...
  describe 'Transactions', ->
    ...
    it 'removes all transactions', (done) ->
      ...
      Meteor.call "removeAllTransactions",  =>
        ...
        insertTransaction.call this, tran1, =>

          insertTransaction.call this, tran2, ->

            Meteor.call "removeAllTransactions", (error, result) ->

              should.not.exist error
              result.should.contain "Removed 2"
              done()
  ...
  describe 'Causes', ->
    ...
    it 'calculates totals per cause', ->
      ...
      # Come out sorted highest first
      tds[0].innerHTML.should.have.string "Test cause 2"
      tds[1].innerHTML.should.have.string "1000"
      tds[2].innerHTML.should.have.string "Test cause"
      tds[3].innerHTML.should.have.string "579.78"
      tds[5].innerHTML.should.have.string "$1579.78"
